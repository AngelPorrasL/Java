...
public class RegistroReservas extends javax.swing.JFrame {
    ...
    public RegistroReservas() {
        ...
        String[]h1 = {"Double","2","29 de febrero","06 de marzo"};
        String[]h2 = {"King","2","11 de septiembre","25 de septiembre"};
        String[]h3 = {"Individual","3","25 de noviembre","15 de diciembre"};
        String[]h4 = {"Suite","1","5 de enero","24 de enero"};
